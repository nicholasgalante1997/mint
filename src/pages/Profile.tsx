        ...
        <React.Fragment>
            ...
            <main className={ProfilePageClassNames.main}>
                <div className={ProfilePageClassNames.infoRoot}>
                    ...
                    <div>
                        <Heading style={{ color: colorBaseBluePrimary }} as="h1" className={ProfilePageClassNames.name}>Nick Galante</Heading>
                        <Heading as="h4">Senior Software Engineer, Design Technologist IV @ Charter Communications</Heading>
                    </div>
                </div>
            </main>
        </React.Fragment>
